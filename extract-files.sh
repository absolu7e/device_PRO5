...
DEVICE_BASE=/home/absolu7e/cm/vendor/$VENDOR/$DEVICE/proprietary
rm -rf $DEVICE_BASE/*

# Extract the device specific files
extract /home/absolu7e/cm/device/$DEVICE_VENDOR/$DEVICE/device-proprietary-files.txt $DEVICE_BASE
